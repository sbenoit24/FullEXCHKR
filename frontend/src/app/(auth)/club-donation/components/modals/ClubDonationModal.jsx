...
export default function ClubDonationModal({ donatorData, isOpen, onClose }) {
  ...
  const handleContinue = async () => {
    ...
    try {
      ...
      const response = await authService.donationPaymentToClub(payload);
  ...
  const paymentMethods = [
    {
      ...
      component: (
        <CardPaymentForm
          memberData={{
            name: donatorData?.donatorName,
            email: donatorData?.donatorEmail,
          }}
          paymentDetails={{
            amount: amountInDollars,
            clubId: donatorData?.clubId,
            donatorName: donatorData?.donatorName,
            donatorEmail: donatorData?.donatorEmail,
          }}
          paymentType="club-donation"
